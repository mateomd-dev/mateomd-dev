...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"281-vFd5qYCy7TF+c8/Mw1ZSZ9Cy9uc\"","mtime":"2023-01-02T15:52:24.987Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"368-/m+E+m0GHq/etPn72qDtU7SOew0\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projects:3d-voxel-engine.md"]: {
    import: () => import('../raw/3d-voxel-engine.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"2a7-4dT9utn1uiro0POjMpXcnUkjrno\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projects:effectivenes-of-skip-connections-in-object-recognition.md"]: {
    import: () => import('../raw/effectivenes-of-skip-connections-in-object-recognition.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"3d4-6k2HFZkS+YB2SBrLIEuMzlk+k88\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projects:machine-learning-visualizer.md"]: {
    import: () => import('../raw/machine-learning-visualizer.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"33a-aqfAKIENS8uSq3Gk1Rr92UU1wxQ\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projects:maeve-self-driving-car.md"]: {
    import: () => import('../raw/maeve-self-driving-car.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"304-A3sPz+xcFmR9BTdGgqzznSnr8RM\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:projects:vision-pipeline-for-self-driving-cars.md"]: {
    import: () => import('../raw/vision-pipeline-for-self-driving-cars.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"3a9-HYpxANSfFDynXtNBaR5iiU04oO4\"","mtime":"2023-01-02T15:52:24.994Z"}
  },
  ["nitro:bundled:cache:content:parsed:content:articles:how-i-built-a-real-self-driving-car-from-scratch:index.md"]: {
    import: () => import('../raw/index.mjs').then(r => r.default || r),
    meta: {"type":"text/markdown; charset=utf-8","etag":"\"92a0-HSeKZZk7MRDNJE25u97UbSkm7EU\"","mtime":"2023-01-02T15:52:24.994Z"}
  }
};
...
const _vmuNIV = defineEventHandler(async (event) => {
...
const _KcIf8N = defineEventHandler(async (event) => {
...
const _reNeXB = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_UyEZU1 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UyEZU1, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _vmuNIV, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _vmuNIV, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _vmuNIV, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1672674721332.json', handler: _KcIf8N, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _reNeXB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _reNeXB, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _reNeXB, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_UyEZU1, lazy: true, middleware: false, method: undefined }
];
